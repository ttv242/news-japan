<nav class="menu-desktop">
    ...
    <ul class="main-menu">
        ...
        <li class="mega-menu-item">
            <a href="category-01.php">Tin tức</a>
            <div class="sub-mega-menu">
                <div class="nav flex-column nav-pills" role="tablist">
                    <a class="nav-link active" data-toggle="pill" href="#news-0" role="tab">All</a>
                    <a class="nav-link" data-toggle="pill" href="#news-1" role="tab">Giải trí</a>
                    <a class="nav-link" data-toggle="pill" href="#news-2" role="tab">Thời trang</a>
                    <a class="nav-link" data-toggle="pill" href="#news-3" role="tab">Đời sống</a>
                    <a class="nav-link" data-toggle="pill" href="#news-4" role="tab">Công nghệ</a>
                    <a class="nav-link" data-toggle="pill" href="#news-5" role="tab">Du lịch</a>
                    <a class="nav-link" data-toggle="pill" href="#news-6" role="tab">Pháp Luật</a>
                    <a class="nav-link" data-toggle="pill" href="#news-6" role="tab">Doanh Nghiệp</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <div>
                                    ...
                                    <div class="p-t-10">
                                        <h5 class="p-b-5">
                                            <a href="../assets/blog-detail-01.php" class="f1-s-5 cl3 hov-cl10 trans-03">
                                                Donec metus orci, malesuada et lectus vitae
                                            </a>
                                        </h5>
                                        <span class="cl8">
        ...
        <li class="mega-menu-item">
            <a href="category-02.php">Giải trí </a>
            <div class="sub-mega-menu">
                <div class="nav flex-column nav-pills" role="tablist">
                    ...
                    <a class="nav-link" data-toggle="pill" href="#enter-3" role="tab">Người nổi tiếng</a>
                    <a class="nav-link" data-toggle="pill" href="#enter-3" role="tab">thể thao</a>
                    <a class="nav-link" data-toggle="pill" href="#enter-4" role="tab">Video</a>
        ...
        <li class="mega-menu-item">
            <a href="category-01.php">Kinh danh</a>
            <div class="sub-mega-menu">
                <div class="nav flex-column nav-pills" role="tablist">
                    <a class="nav-link active" data-toggle="pill" href="#business-1" role="tab">All</a>
                    <a class="nav-link" data-toggle="pill" href="#business-2" role="tab">Kinh tế</a>
                    <a class="nav-link" data-toggle="pill" href="#business-3" role="tab">Tài chính</a>
                    <a class="nav-link" data-toggle="pill" href="#business-4" role="tab">Chứng khoáng</a>
        ...
        <li class="mega-menu-item">
            <a href="category-02.php">Du lịch</a>
            <div class="sub-mega-menu">
                <div class="nav flex-column nav-pills" role="tablist">
                    <a class="nav-link active" data-toggle="pill" href="#travel-1" role="tab">All</a>
                    <a class="nav-link" data-toggle="pill" href="#travel-2" role="tab">Khách sạn</a>
                    <a class="nav-link" data-toggle="pill" href="#travel-3" role="tab">Địa điểm</a>
        ...
        <li class="mega-menu-item">
            <a href="category-02.php">Video</a>
            <div class="sub-mega-menu">
                <div class="nav flex-column nav-pills" role="tablist">
