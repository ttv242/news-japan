...
<section class="bg0">
  <div class="row m-rl-0 justify-content-center">
    <div class="col-md-4 p-rl-1 p-b-2">
      <div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(../assets/images/post-01.jpg);">
        <a href="blog-detail-02.php" class="dis-block how1-child1 trans-03"></a>
        <div class="flex-col-e-s s-full p-rl-25 p-tb-18">
          <a href="#" class="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
            Technology
          </a>
          <h3 class="how1-child2 m-t-14 m-b-10">
            <a href="blog-detail-02.php" class="f1-l-1 cl0 hov-cl10 trans-03 respon1">
    ...
    <div class="col-md-4 p-rl-1 p-b-2">
      <div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(../assets/images/post-19.jpg);">
        <a href="blog-detail-02.php" class="dis-block how1-child1 trans-03"></a>
        <div class="flex-col-e-s s-full p-rl-25 p-tb-18">
          <a href="#" class="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
            Technology
    ...
    <div class="col-md-4 p-rl-1 p-b-2">
      <div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(../assets/images/post-20.jpg);">
        <a href="blog-detail-02.php" class="dis-block how1-child1 trans-03"></a>
        <div class="flex-col-e-s s-full p-rl-25 p-tb-18">
          <a href="#" class="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
            Life Style
          ...
          <div class="p-b-25">
            ...
            <div class="flex-wr-sb-s p-t-35">
              <div class="size-w-6 w-full-sr575">
                ...
                <div class="m-b-30">
                  <a href="blog-detail-02.php" class="wrap-pic-w hov1 trans-03">
                    <img src="../assets/images/post-21.jpg" alt="IMG">
                  </a>
                  <div class="p-t-25">
                    <h5 class="p-b-5">
                      <a href="blog-detail-02.php" class="f1-m-3 cl2 hov-cl10 trans-03">
            ...
            <div class="row p-t-35">
              <div class="col-sm-6 p-r-25 p-r-15-sr991">
                ...
                <div class="flex-wr-sb-s m-b-30">
                  <a href="blog-detail-02.php" class="size-w-1 wrap-pic-w hov1 trans-03">
